...
const SignUpForm = () => {
    ...
    const { values,errors, focus, changeHandler, addFocus, removeFocus, submitHandler } = useForm(validation);
        ...
        <form onSubmit={submitHandler} className="form">
            ...
            <div className={!(focus.username) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.username && focus.username) && <i class='bx bx-error-circle form__icon-error'></i>}
                    {(errors.username && focus.username) && <span className="form__error"><i class='bx bxs-left-arrow' id="icon__arrow"></i>{errors.username}</span>}
                </div>
            </div>
            <div className={!(focus.email) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.email && focus.email) && <i class='bx bx-error-circle form__icon-error'></i>}
                    {(errors.email && focus.email) && <span className="form__error"><i class='bx bxs-left-arrow' id="icon__arrow"></i>{errors.email}</span>}
                </div>
            </div>
            <div className={!(focus.password) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.password && focus.password) && <i class='bx bx-error-circle form__icon-error'></i>}
                    {(errors.password && focus.password) && <span className="form__error"><i class='bx bxs-left-arrow' id="icon__arrow"></i>{errors.password}</span>}
                </div>
            </div>
            <div className={!(focus.confirmPassword) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    <label className={!(focus.confirmPassword) ? "form__label" : "form__label focus"}>Confirm Password</label>
                    ...
                    {(errors.confirmPassword && focus.confirmPassword) && <i class='bx bx-error-circle form__icon-error'></i>}
                    {(errors.confirmPassword && focus.confirmPassword) && <span className="form__error"><i class='bx bxs-left-arrow' id="icon__arrow"></i>{errors.confirmPassword}</span>}
                </div>
            </div>
