        ...
        <form onSubmit={submitHandler} className="form">
            ...
            <div className={!(focus.username) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.username && focus.username) && <span className="form__error"><i class='bx bxs-left-arrow' id="arrow__icon"></i>{errors.username}</span>}
                </div>
            </div>
            <div className={!(focus.email) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.email && focus.email) && <span className="form__error"><i class='bx bxs-left-arrow' id="arrow__icon"></i>{errors.email}</span>}
                </div>
            </div>
            <div className={!(focus.password) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.password && focus.password) && <span className="form__error"><i class='bx bxs-left-arrow' id="arrow__icon"></i>{errors.password}</span>}
                </div>
            </div>
            <div className={!(focus.confirmPassword) ? "form__field" : "form__field focus"}>
                <div className="form__input-div">
                    ...
                    {(errors.confirmPassword && focus.confirmPassword) && <span className="form__error"><i class='bx bxs-left-arrow' id="arrow__icon"></i>{errors.confirmPassword}</span>}
                </div>
            </div>
